...
<html lang="en">
    ...
    <body>
        <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link " href="index.php?c=lote" tabindex="-1" aria-disabled="true">Lotes<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
            ...
            <a class="btn btn btn-outline-secondary" href="#" data-toggle="modal" data-target="#modalLoteAdd" >Agregar Lote</a><br><br>
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <td>
                            <a class="btn btn-outline-secondary" href="#" data-toggle="modal" data-target="#modalLoteEdit" onclick="listarById(' . $dato['id_lote'] . ');"title="EDITAR">Editar</a>
                            <a class="btn btn-outline-danger" href="#" title="ELIMINAR" onclick="alertaEliminar(' . $dato['id_lote'] . ',\'Lote\',\'' . $dato['id_lote'] . '\',\'Muestras\')" >Eliminar</a>
                        </td>
        ...
        <?php require_once "modalLoteAdd.html"; ?>
        <?php require_once "modalLoteEdit.html"; ?>
        ...
        <script type="text/javascript" src="Vista/Lote/Lote.js"></script>
    </body>
</html>
...
<html lang="en">
  ...
  <body>
    <div class="container text-center">
        ...
        <h1 class="">Agregar Director Lab</h1><br>
      <form class="col-6 offset-3 border border-secondary rounded p-3 mb-2 bg-light text-dark" method="POST" action="index.php?c=director&a=guardar">
        ...
        <div class="form-group col-6 offset-3">
          ...
          <input type="text" class="form-control" id="firma" name="firma" placeholder="Ingrese la firma" required>
        </div>

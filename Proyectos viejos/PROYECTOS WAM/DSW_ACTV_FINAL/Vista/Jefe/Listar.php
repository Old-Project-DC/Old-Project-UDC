  ...
  <body>
    <div class="container">
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
      	...
      	<a class="btn btn btn-outline-secondary" href="index.php?c=jefe&a=vistaAddJefe">Agregar Jefe Lab</a><br><br>
        <table class="table table-striped">
            ...
            <tbody>
                <?php foreach ($auxi["jefe_lab"] as $dato) {
                    ...
                    echo'<tr>
                        ...
                        <td>
                            <a class="btn btn-outline-secondary" href="index.php?c=jefe&a=vistaEditar&id='.$dato['ID_JEFES'].'" title="EDITAR">Editar</a>
                            <a class="btn btn-outline-danger" title="ELIMINAR" onclick="alertaEliminarEmpleado('.$dato['ID_JEFES'].','.$dato['ID_EMPLEADOS'].','.$dato['ID_USER'].',\'Jefe\',\''.$dato['NOMBRES'].'\')" >Eliminar</a>
                        </td>

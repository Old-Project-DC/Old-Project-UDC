                ...
                <?php foreach ($auxi["lote"] as $dato) {
                    ...
                    echo'<tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-outline-danger" href="index.php?c=lote&a=delete&id='.$dato['id_lote'].'" title="ELIMINAR"
                            onclick="return confirm(\'Desea Eliminar El Registro '.$dato['id_lote'].'?\')" >Eliminar</a>
                        </td>

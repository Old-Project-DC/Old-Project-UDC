<?php 
	...
	class JefeDAO{
		...
		public function editar($jefe_lab, $id){
			...
			$sql="UPDATE ver_jefes_laboratorios SET LABORATORIOS='".$jefe_lab->getTipo_lab()."' WHERE ID_JEFES=".$id;

			$sql2="UPDATE ver_jefes_laboratorios SET NOMBRES='".$jefe_lab->getNom_empleado()."', USUARIOS='".$jefe_lab->getUsuario()."' WHERE ID_JEFES= ".$id;

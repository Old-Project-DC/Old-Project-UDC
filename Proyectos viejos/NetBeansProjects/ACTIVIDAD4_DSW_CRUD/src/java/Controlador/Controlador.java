...
public class Controlador extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("Listar")) {
            ...
            String primapel = request.getParameter("primapel");
            String segapel = request.getParameter("segapel");
            ...
            c.setPrimnom(primnom);
            c.setSegnom(segnom);
            c.setPrimapel(primapel);
            c.setSegapel(segapel);
            ...
            System.err.println("El idientificador es :"+identifi);
            String usuario = request.getParameter("usuario");
            String password = request.getParameter("password");
            String primnom = request.getParameter("primnom");
            String segnom = request.getParameter("segnom");
